...
HIST_SCHEMA = [
    ...
    {"kind": "entry",       "key": "color",          "label": "Bar Colour",
     "hint": "Matplotlib colour name or hex code for histogram bars (e.g. steelblue, #4a90d9)"},
    {"kind": "checkbutton", "key": "kde",            "label": "Show KDE Curve",
     "hint": "Overlay a kernel density estimate curve on the histogram"},
    {"kind": "entry",       "key": "kde_color",      "label": "KDE Colour",
     "hint": "Colour for the KDE line (e.g. navy); only used when Show KDE Curve is enabled"},
